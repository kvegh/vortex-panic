# VORTEX PANIC — Design v1

*Initial design — 2026-07-26*
...
- **Ship**: fixed center-left, simple triangle or rocket shape, facing right
...
## Readout Panel
- Speed: as fraction of c (e.g., 0.87c)
- Lorentz factor γ
...
- Distance to next/selected landmark
