# VORTEX PANIC — Design v4

*Updated 2026-07-26 — incorporates decisions v2, v3, v4*
...
- **Autopilot**: button to engage auto accel/decel to selected destination
  ...
  - Auto-disengages on manual thrust/direction change
...
## Flight Log
- Version shown at startup: "VORTEX PANIC v4"
...
- Logged events:
  ...
  - Autopilot auto-disengage (manual override)
